...
async function main(buildDir) {
    ...
    const x64AppPath = path_1.default.join(buildDir, 'Vaxx-darwin-x64', appName);
    const arm64AppPath = path_1.default.join(buildDir, 'Vaxx-darwin-arm64', appName);
    const asarRelativePath = path_1.default.join('Contents', 'Resources', 'app', 'node_modules.asar');
    const outAppPath = path_1.default.join(buildDir, `Vaxx-darwin-${arch}`, appName);
