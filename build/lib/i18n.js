...
exports.XLF = exports.Line = exports.defaultLanguages = void 0;
...
function processCoreBundleFormat(base, fileHeader, languages, json, emitter) {
    const languageDirectory = path_1.default.join(REPO_ROOT_PATH, '..', 'vaxx-loc', 'i18n');
    ...
    sortedLanguages.forEach((language) => {
        ...
        const i18nFile = path_1.default.join(languageDirectory, `vaxx-language-pack-${languageFolderName}`, 'translations', 'main.i18n.json');
        let allMessages;
...
const workbenchProject = 'vaxx-workbench', setupProject = 'vaxx-setup';
