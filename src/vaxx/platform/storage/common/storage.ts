...
export abstract class AbstractStorageService extends Disposable implements IStorageService {
	...
	async switch(to: IUserDataProfile, preserveData: boolean): Promise<void> {
	...
	abstract hasScope(scope: IUserDataProfile): boolean;
	...
	protected abstract switchToWorkspace(toWorkspace: IUserDataProfile, preserveData: boolean): Promise<void>;
}
