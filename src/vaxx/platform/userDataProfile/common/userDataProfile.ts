...
export interface IUserDataProfilesService {
	...
	createNamedProfile(name: string, options?: IUserDataProfileOptions): Promise<IUserDataProfile>;
	createTransientProfile(): Promise<IUserDataProfile>;
	createProfile(id: string, name: string, options?: IUserDataProfileOptions): Promise<IUserDataProfile>;
...
export class UserDataProfilesService extends Disposable implements IUserDataProfilesService {
	...
	async createTransientProfile(): Promise<IUserDataProfile> {
		...
		return this.createProfile(hash(generateUuid()).toString(16), name, { transient: true });
	}

	async createNamedProfile(name: string, options?: IUserDataProfileOptions): Promise<IUserDataProfile> {
		return this.createProfile(hash(generateUuid()).toString(16), name, options);
	}

	async createProfile(id: string, name: string, options?: IUserDataProfileOptions): Promise<IUserDataProfile> {
	...
	async setProfileForWorkspace(profileToSet: IUserDataProfile): Promise<void> {
